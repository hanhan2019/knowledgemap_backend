...
func (*CRqQueryMapBySubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_64d3aa4478f699f4, []int{2}
}
func (m *CRqQueryMapBySubject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CRqQueryMapBySubject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CRqQueryMapBySubject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *CRqQueryMapBySubject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CRqQueryMapBySubject.Merge(m, src)
}
func (m *CRqQueryMapBySubject) XXX_Size() int {
	return m.Size()
}
func (m *CRqQueryMapBySubject) XXX_DiscardUnknown() {
	xxx_messageInfo_CRqQueryMapBySubject.DiscardUnknown(m)
}

var xxx_messageInfo_CRqQueryMapBySubject proto.InternalMessageInfo
...
func (*KnowledegeMapInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_64d3aa4478f699f4, []int{3}
}
...
func (*CRqQueryMyMapBySubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_64d3aa4478f699f4, []int{4}
}
func (m *CRqQueryMyMapBySubject) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CRqQueryMyMapBySubject) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CRqQueryMyMapBySubject.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *CRqQueryMyMapBySubject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CRqQueryMyMapBySubject.Merge(m, src)
}
func (m *CRqQueryMyMapBySubject) XXX_Size() int {
	return m.Size()
}
func (m *CRqQueryMyMapBySubject) XXX_DiscardUnknown() {
	xxx_messageInfo_CRqQueryMyMapBySubject.DiscardUnknown(m)
}

var xxx_messageInfo_CRqQueryMyMapBySubject proto.InternalMessageInfo
...
var fileDescriptor_64d3aa4478f699f4 = []byte{
	...
	0xa1, 0xf0, 0x94, 0x02, 0xb9, 0xc4, 0xe0, 0x2e, 0x41, 0x75, 0x8b, 0x00, 0x17, 0xc8, 0xc9, 0x10,
	0x63, 0x82, 0x40, 0x4c, 0x64, 0xd7, 0x31, 0xe1, 0x76, 0x9d, 0xd1, 0x3a, 0x46, 0x2e, 0x5e, 0x14,
	0xe7, 0x09, 0x05, 0x70, 0x49, 0xba, 0xa7, 0x96, 0xa0, 0x88, 0x21, 0xec, 0x91, 0xd4, 0x4b, 0x2c,
	0xc8, 0xd4, 0xc3, 0x16, 0x1c, 0x52, 0x62, 0x60, 0x29, 0x0c, 0xaf, 0x2a, 0x31, 0x08, 0x79, 0x73,
	0x09, 0xb9, 0xa7, 0x96, 0xf8, 0x56, 0xa2, 0xda, 0x23, 0x8d, 0x6a, 0x14, 0x91, 0x86, 0x39, 0x09,
	0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb,
	0x31, 0x24, 0xb1, 0x81, 0xe3, 0xd6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xff, 0xe2, 0xac, 0xa1,
	0x29, 0x02, 0x00, 0x00,
}
